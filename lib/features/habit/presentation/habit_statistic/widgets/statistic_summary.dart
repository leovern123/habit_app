...
Widget build(BuildContext context) {
  ...
  final endText =
      '${endDisplay.day}/${endDisplay.month}/${endDisplay.year}';
  ...
  return StreamBuilder<QuerySnapshot>(
    ...
    builder: (context, habitSnap) {
      ...
      final activeHabitIds =
          habitSnap.data!.docs.map((e) => e.id).toSet();
      ...
      return StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, logSnap) {
          ...
          final logs = logSnap.data!.docs.where((doc) {
            return activeHabitIds.contains(doc['habitId']);
          }).toList();
